...
# ElasticExportKelkooPremiumDE plugin for plentymarkets 7

This is the ElasticExportKelkooPremiumDE plugin for plentymarkets 7 which extends the list of possible export formats.
